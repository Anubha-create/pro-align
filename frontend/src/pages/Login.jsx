...
import { Lock, Mail, RefreshCw, Sun, Moon } from 'lucide-react';
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-600 text-white p-10 md:p-12 flex flex-col justify-between relative overflow-hidden hidden md:flex">
          ...
          <div className="space-y-4 text-left z-10 my-auto">
            <h1 className="text-4xl font-extrabold tracking-tight leading-tight">
              Alignment <br />starts here
            </h1>
            <p className="text-slate-100/80 text-xs leading-relaxed max-w-xs">
              Sign in to verify your matching analytics, perfect your STAR answers, and customize reports.
            </p>
          </div>
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center bg-slate-50 dark:bg-slate-900/50 relative">
          ...
          <div className="max-w-sm w-full mx-auto space-y-6">
            ...
            <div className="text-center md:text-left space-y-1">
              ...
              <p className="text-xs text-slate-400">Sign in to your dashboard console.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4" autoComplete="off">
              ...
              <div className="flex justify-between items-center text-xs">
                ...
                <Link 
                  to="/forgot-password" 
                  className="text-blue-500 hover:text-blue-400 transition font-bold"
                >
                  Forgot Password?
                </Link>
              </div>
              ...
              >
                {loading ? <RefreshCw className="w-3.5 h-3.5 animate-spin" /> : 'Login'}
              </button>
            </form>
            ...
            <div className="text-center text-xs text-slate-400">
              ...
              <Link to="/signup" className="text-blue-500 hover:text-blue-400 font-bold transition">
                Create Account
              </Link>
            </div>
          </div>
